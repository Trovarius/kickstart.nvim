...
```sh
# on Linux and Mac
git clone https://github.com/trovarius/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```


```
# on Windows (cmd)
git clone https://github.com/trovarius/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```

```
# on Windows (powershell)
git clone https://github.com/trovarius/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
...
* Why is the kickstart `init.lua` a single file? Wouldn't it make sense to split it into multiple files?
  ...
  * Discussions on this topic can be found here:
    * [Restructure the configuration](https://github.com/trovarius/kickstart.nvim/issues/218)
    * [Reorganize init.lua into a multi-file setup](https://github.com/trovarius/kickstart.nvim/pull/473)
